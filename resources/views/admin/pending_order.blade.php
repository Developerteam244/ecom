...
@section('admin.pending_order', 'active')
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <span class="text-white fw-semibold me-1">
                                            ...
                                            <a href="{{route('admin.order_status',['id'=>$list->id,'order_id'=>$add->id])}}">
                                                <i class="fa  fa-circle-check product_icon" style="color: #bcc7e1;"></i>
                                            </a>
                                            @else
                                            <i class="fa  fa-circle-check product_icon" style="color:green"></i>
                                            @endif
                                            <a href="{{route('admin.order_cancel',['id'=>$list->id,'order_id'=>$add->id])}}">
                                                <i class="fa  fa-circle-xmark product_icon" style="color: #f30c1c;"></i>
                                            </a>
                                        </span>
                                    </td>
