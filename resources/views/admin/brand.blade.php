...
@section('admin.all_brand', 'active')
                ...
                <tbody>
                    ...
                    @foreach ($brand as $list)
                        <tr>
                            ...
                            <td>
                                <span class="badge bg-success">{{ $list->slug }}</span>
                            </td>

                            <td class="text-center fs-sm">
                                <a class="btn btn-sm btn-alt-secondary"
                                    href="{{ route('admin.edit_brand', ['id' => $list->id]) }}">
                                    <i class="fa fa-fw fa-eye"></i>
                                </a>
                                <a class="btn btn-sm btn-alt-secondary"
                                    href="{{ route('admin.brand_delete', ['id' => $list->id]) }}">
