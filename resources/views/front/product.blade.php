                            ...
                            <div class="swiper-wrapper product_preview" >
                                <div class="swiper-slide" id="product_preview">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('storage/media/product/'.$product->image)}}"><img class="product__media--preview__items--img" src="{{asset('storage/media/product/'.$product->image)}}"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{asset('storage/media/product/'.$product->image)}}" data-gallery="product-media-preview">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('storage/media/product_img/'.$list->image)}}"><img class="product__media--preview__items--img" src="{{asset('storage/media/product_img/'.$list->image)}}"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{asset('storage/media/product_img/'.$list->image)}}" data-gallery="product-media-preview">
                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                <span class="visually-hidden">product view</span>
                                            </a>
                                        </div>
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide slide_page">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{asset('storage/media/product/'.$product->image)}}" alt="product-nav-img">
                                    </div>
                                </div>
                                @foreach ($product_image as $list)
                                <div class="swiper-slide slide_page">
                                    <div class="product__media--nav__items">
                                        <img class="product__media--nav__items--img" src="{{asset('storage/media/product_img/'.$list->image)}}" alt="product-nav-img">
                                    </div>
                                </div>
                                @endforeach
                            ...
                            <div class="product__variant">
                                    ...
                                    <fieldset class="variant__input--fieldset">
                                        ...
                                        <div class="variant__color d-flex">
                                            @foreach ($product_color as $list)
                                                ...
                                                <div class="variant__color--list product_color" data-size="{{$list['size']}}" data-product-image ="{{$list['image']}}" data-color-id="{{$list['color_id']}}" >
                                                    <input id="color-red5" name="color" type="radio" >
                                                    <label class="variant__color--value red " for="color-red5" title="{{$list['color']}}">
                                                    </div>
                                                    @endif
                                                @endforeach
                                ...
                                <div class="product__variant--list mb-20">
                                    <fieldset class="variant__input--fieldset">
                                        ...
                                        <ul class="variant__size d-flex">
                                            ...
                                            <li class="variant__size--list product_size_item"  data-size="{{$list['size']}}" >
                                                <input id="{{$list['size_id']}}" name="weight" type="radio" >
                                                <label class="variant__size--value red" for="{{$list['size_id']}}" >{{$list['size']}}</label>
                                            </li>
                                            @endforeach
                                ...
                                <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                    <div class="quantity__box">
                                        ...
                                        <label>
                                            <input type="number" class="quantity__number quickview__value--number" value="1" id="qty" data-counter />
                                        </label>
                                        <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                    </div>
                                    <button class="primary__btn quickview__cart--btn add_to_cart" id="add_to_cart" type="button" data-color-cond="{{$color_id}}" data-product_slug="{{$product->slug}}" data-size-cond="{{$size_id}}">Add To Cart</button>
            ...
            <div class="row row-cols-1">
                <div class="col">
                    <ul class="product__tab--one product__details--tab d-flex mb-30">
                        ...
                        <li class="product__details--tab__list" data-toggle="tab" data-target="#technical_specification">Technical Specification </li>
                        <li class="product__details--tab__list" data-toggle="tab" data-target="#uses">Uses</li>
                        <li class="product__details--tab__list" data-toggle="tab" data-target="#warranty">Warranty</li>
                    </ul>
                    <div class="product__details--tab__inner border-radius-10">
                        <div class="tab_content">
                            ...
                            <div id="technical_specification" class="tab_pane active">
                                <div class="product__tab--content">
                    ...
                    <div class="swiper-slide">
                        <article class="product__card">
                            ...
                            <div class="product__card--content">
                                ...
                                <h3 class="product__card--title"><a href="{{$list->slug}}">{{$list->name}}
                                    Camera </a></h3>
