                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                                            <article class="product__card">
                                                ...
                                                <div class="product__card--content">
                                                    ...
                                                    <h3 class="product__card--title"><a href="product-details.html"> {{$list->name}}
                                                         </a></h3>
                                                    <div class="product__card--price">
                                                        <span class="current__price">{{$list->price}}</span>
                                                        <span class="old__price">{{$list->mrp}}</span>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 col-6 custom-col mb-30">
                                    <article class="product__card">
                                        ...
                                        <div class="product__card--content">
                                            ...
                                            <h3 class="product__card--title"><a href="product-details.html">{{$list->name}} </a></h3>
                                            <div class="product__card--price">
                                                <span class="current__price">{{$list->price}}</span>
                                                <span class="old__price"> {{$list->mrp}}</span>
                                            </div>
                        ...
                        @foreach ($discounted_product as $key=>$list )
                            ...
                            <div class="small__product--card style2 d-flex mx-2 mb-25 w-25">
                                <div class="small__product--thumbnail">
                                    <a class="display-block" href="product/{{$list->slug}}"><img src="{{asset('storage/media/product/'.$list->image)}}" alt="product-img"></a>
                                </div>
                                <div class="small__product--content">

                                    <h3 class="small__product--card__title"><a href="product-details.html">{{$list->name}} </a></h3>
                                    <div class="product__card--price">
                                        <span class="current__price">{{$list->price}}</span>
                                        <span class="old__price"> {{$list->mrp}}</span>
                                    </div>
