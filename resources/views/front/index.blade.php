                        ...
                        <article class="product__card">
                            ...
                            <div class="product__card--content">
                                ...
                                <div class="product__card--footer">
                                    <a class="product__card--btn primary__btn add_to_cart" href="javascript:void(0)" data-color-cond="0" data-product_slug="{{$list->slug}}" data-size-cond="0" data-size="{{$list->size}}" data-color="{{$list->color}}">
