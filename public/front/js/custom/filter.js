        ...
        <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
            <article class="product__card">
                ...
                <div class="product__card--content">
                    ...
                    <div class="product__card--footer add_to_cart"  data-color-cond="0" data-product_slug="${product.slug}" data-size-cond="0" data-size="${product.size}" data-color="${product.color}">
 ...
 const product_list_html= (item)=>{
    ...
    <div class="product__card product__list d-flex align-items-center">
        ...
        <div class="product__card--content product__list--content">
            ...
            <a class="product__card--btn primary__btn add_to_cart"  href="javascript:void(0)" data-product_slug="${product.slug}" data-size-cond="0" data-size="${product.size}" data-color-cond="0" data-color="${product.color}">+ Add to cart</a>
        </div>
    </div>
</div>`;
